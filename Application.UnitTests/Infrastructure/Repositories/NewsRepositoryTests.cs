...
namespace Application.UnitTests.Infrastructure.Repositories
{
    [TestFixture]
    public class NewsRepositoryTests
    {
        private readonly NewsRepository _sut;
        private readonly Mock<(IdentityDbContext<User>, IApplicationDbContext)> _mockContext = new Mock<(IdentityDbContext<User>, IApplicationDbContext)>();
